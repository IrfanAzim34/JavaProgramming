...
public class Task4 {
    ...
    Write a program that can print the numbers between 1 ~ N that can be divisible by 3, 5, and 15.
            ...
            if the number can be divisible by 3 butcannot be divisible by 15,
                then it should only be displayed in DivisibelBy3' section

            if the number can be divisible by 5 butcannot be divisible by 15,
                then it should only be displayed inDivisibelBy5' section
